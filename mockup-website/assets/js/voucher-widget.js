...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.bss-v-head{background:' + NAVY + ';border-radius:16px 16px 0 0;padding:20px 24px;display:flex;align-items:center;justify-content:space-between;}',
      '.bss-v-head h2{color:#fff;font-family:"Playfair Display",serif;font-size:20px;font-weight:500;margin:0;}',
      '.bss-v-head .bss-v-close{background:none;border:none;color:rgba(255,255,255,0.7);font-size:22px;cursor:pointer;padding:4px 8px;line-height:1;border-radius:6px;transition:color 0.15s;}',
      '.bss-v-head .bss-v-close:hover{color:#fff;}',
      ...
      '.bss-v-tab.active{border-color:' + NAVY + ';background:' + NAVY + ';color:#fff;}',
      /* amount grid */
      ...
      '.bss-v-amt.selected{border-color:' + NAVY + ';background:' + NAVY + ';color:#fff;}',
      /* treatment list */
      ...
      '.bss-v-field input:focus,.bss-v-field textarea:focus{border-color:' + NAVY + ';}',
      ...
      /* button */
      '.bss-v-btn{display:block;width:100%;padding:14px;background:' + NAVY + ';color:#fff;border:none;border-radius:10px;font-size:15px;font-weight:600;cursor:pointer;font-family:Inter,sans-serif;transition:background 0.15s;margin-top:8px;}',
      '.bss-v-btn:hover{background:' + NAVY2 + ';}',
