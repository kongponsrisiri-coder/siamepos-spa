    ...
    <div className="modal-backdrop" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal" style={{ maxWidth: 520 }} onClick={e => e.stopPropagation()}>
        ...
        {/* SPA-SWAP — swap therapist + room with another booking is now
            done by dragging one appointment block onto another on the
            timeline (SPA-SWAP-DND). The dropdown-based picker that
            used to live here was removed because two routes to the
            same action just added clutter. */}
